...
import com.mongodb.jvm.nashorn.NashornBsonImplementationOld;
import com.mongodb.jvm.rhino.MongoRhinoJsonImplementation;
import com.mongodb.jvm.rhino.RhinoBsonImplementationOld;
 ...
 * @author Tal Liron
 */
public class BSONOld
{
	//
	// Static attributes
	//

	public static BsonImplementationOld getImplementation()
	{
		return implementation;
	}

	public static void setImplementation( BsonImplementationOld implementation )
	{
		BSONOld.implementation = implementation;
	}
	...
	private static volatile BsonImplementationOld implementation;

	static
	{
		try
		{
			implementation = new NashornBsonImplementationOld();
		}
		catch( NoClassDefFoundError x )
		{
			// Nashorn not available
			implementation = new RhinoBsonImplementationOld();
		}
		catch( UnsupportedClassVersionError x )
		{
			// Nashorn requires at least JVM 7
