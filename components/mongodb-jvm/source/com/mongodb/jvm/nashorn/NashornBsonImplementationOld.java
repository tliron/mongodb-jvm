...
import com.mongodb.jvm.BsonImplementationOld;
 ...
 * @author Tal Liron
 */
public class NashornBsonImplementationOld implements BsonImplementationOld
{
	//
	// Construction
	//

	public NashornBsonImplementationOld()
	{
	...
	public Object from( Object object, boolean extendedJSON )
	{
		...
		{
			Document document = BSONOld.toDocument( (BsonDocument) object );
